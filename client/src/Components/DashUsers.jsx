...
//   console.log(userPost)
  useEffect(()=>{
    const fetchUsers=async()=>{
      try {
        const res=await fetch(`/app/v1/user/getUsers`)
          ...
          <>
            <Table hoverable className='shadow-md'>
              <Table.Head>
                ...
                <Table.HeadCell>User email address</Table.HeadCell>
                ...
                users.map((user)=>(
                  <Table.Body className='divide-y' key={user._id}>
                    <Table.Row className='bg-white dar:border-gray-700 dark:bg-gray-800'>
                      ...
                      <Table.Cell>
                        <span className='font-mediumtext-red-500 hover:underline hover:cursor-pointer' onClick={()=>{setShowModal(true);setUserIdToDelete(user._id);}}>
                          Delete
                        </span>
                      </Table.Cell>
